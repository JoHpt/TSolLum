...
def load_spectra() -> dict:
    ...
    for metallic, semiconductive in zip(metallic_spectra, semiconductive_spectra):
        ...
        metallic_spec.rename(columns={metallic_spec.columns[0]: "Wavelength (nm)"}, inplace = True)
        ...
        semiconductive_spec.rename(columns={semiconductive_spec.columns[0]: "Wavelength (nm)"}, inplace = True)
